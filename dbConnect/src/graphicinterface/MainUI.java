...
public class MainUI implements ChangeListener, ActionListener, ListSelectionListener{
	...
	private Container createMainPanel() {
		...
		mainPanel.add("Iniciar Entrenamiento", trainingUI.createMainPanel());
		//mainPanel.add("Mis Entrenamientos", trainingDataUI.createMainPanel());
		//mainPanel.add("Mis Estadísticas", trainingUI.createMainPanel());
		//mainPanel.add("Mis Perfil", trainingUI.createMainPanel());
